...
class Config:
    ...
    AGGREGATOR_PORT = int(os.getenv("AGGREGATOR_PORT", "8003"))
    ...
    LTM_SERVER_URL = os.getenv("LTM_SERVER_URL", "http://localhost:8000")
    LTM_SERVER_TIMEOUT = int(os.getenv("LTM_SERVER_TIMEOUT", "30"))
    
    # Legacy: Keep for backward compatibility
    GRAPH_SERVER_URL = os.getenv("GRAPH_SERVER_URL", os.getenv("LTM_SERVER_URL", "http://localhost:8000"))
